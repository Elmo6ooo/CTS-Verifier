...
def BYOD_Managed_Provisioning(device):
    ...
    if d(text="BYOD Managed Provisioning").exists:
        ...
        if d(text="Badged work apps visible in Launcher").exists:
            ...
            d.press("home")
            time.sleep(1)
            d.swipe(540,2000,540,900,steps=10)
            time.sleep(1)
            click(d,'t',"NEXT",1)
            click(d,'t',"GOT IT",1)
            click(d,'t',"WORK",1)
        ...
        if d(text="Profile-aware accounts settings").exists:
            ...
            click(d,'t',"GO",1)
            d(scrollable=True).scroll.to(text="Accounts")
            click(d,'t',"Accounts",1)
            click(d,'t',"Work",1)
            tmp = d.dump()
            nPress(d,2,"recent",1)
        ...
        if d(text="Personal ringtones").exists:
            ...
            click(d,'t',"GO",1)
            d.swipe(540,1500,540,900,steps=10)
            time.sleep(1)
            click(d,'t',"Advanced",1)
            d(className="androidx.recyclerview.widget.RecyclerView").scroll.toEnd()
            if d(resourceId="android:id/switch_widget")[5].checked:
                d(resourceId="android:id/switch_widget")[5].click()
                time.sleep(1)
        ...
        if d(text="Non-market app installation restrictions").exists:
            ...
            click(d,'t',"GO",1)
            Fail = False
            if not d(text="Action not allowed").exists:
                Fail = True
            else:
                click(d,'t',"OK",1)
            if not Fail:
            ...
            d.press("back")
            time.sleep(1)
            d(resourceId="android:id/list").scroll.to(text="Non-market app installation restrictions")
            click(d,'t',"Non-market app installation restrictions",1)
            click(d,'t',"Enable non-market apps",1)
            click(d,'t',"GO",1)
            click(d,'t',"INSTALL",1)
            Fail2 = False
            if d(text="Action not allowed").exists:
                Fail2 = True
            if not Fail2:
                click(d,'t',"PASS",1)
            else:
        ...
        if d(text="Permissions lockdown").exists:
            ...
            Fail = False
            if not d(text="Allow").enabled or not d(text="Deny").enabled:
                Fail = True
            nPress(d,3,"back",1)
            click(d,'t',"Grant",1)
            click(d,'t',"OPEN APPLICATION SETTINGS",1)
            ...
            click(d,'t',"Contacts",1)
            Fail2 = False
            if d(text="Allow").enabled  or d(text="Deny").enabled or d(text="Deny").checked:
                Fail2 = True
            nPress(d,3,"back",1)
            click(d,'t',"Deny",1)
            click(d,'t',"OPEN APPLICATION SETTINGS",1)
            ...
            click(d,'t',"Contacts",1)
            Fail3 = False
            if d(text="Allow").enabled  or d(text="Deny").enabled or d(text="Allow").checked:
                Fail3 = True
            nPress(d,4,"back",1)
            if not Fail and not Fail2 and not Fail3:
                click(d,'t',"PASS",1)
        ...
        if d(text="Turn off work profile").exists:
            ...
            d.swipe(540,2000,540,900,steps=10)
            time.sleep(1)
            click(d,'r',"com.android.launcher3:id/work_mode_toggle",2)
            ...
            d.swipe(540,2000,540,900,steps=10)
            time.sleep(1)
            click(d,'r',"com.android.launcher3:id/work_mode_toggle",1)
            d.press("home")
            time.sleep(1)
            click(d,'t',"Files",1)
            Fail2 = False
            if not d(text="Turn on work profile?"):
                Fail2 = True
            click(d,'t',"CANCEL",1)
            nPress(d,2,"recent",1)
        ...
        if d(text="Select work lock test").exists:
            ...
            Fail = False
            try:
                click(d,'r',"com.android.settings:id/lock_none",1)
                click(d,'t',"PIN",1)
        ...
        if d(text="Confirm work lock test").exists:
            ...
            try:
                if "android.widget.ImageView" in d(text="CtsVerifier").up().info['className']:
                    d(className="android.widget.EditText").set_text("0000")
                    d.press("enter")
                    time.sleep(1)
                if d(text="Turn on work apps?"):
                    Fail = True
        ...
        if d(text="Confirm pattern lock test").exists:
            ...
            click(d,'r',"com.android.settings:id/lock_none",1)
            click(d,'t',"Pattern",1)
            d.swipePoints([(265,1050),(265,1625),(840,1625)],steps=20)
            click(d,'t',"NEXT",1)
            d.swipePoints([(265,1050),(265,1625),(840,1625)],steps=20)
            click(d,'t',"CONFIRM",1)
            d.screen.off()
            ...
            try:
                if "android.widget.ImageView" in d(text="CtsVerifier").up().info["className"]:
                    d.swipePoints([(237,1050),(237,1670),(837,1670)],steps=20) 
                    time.sleep(1)
                if d(text="Turn on work apps?"):
                    Fail = True
            except:
        ...
        if d(text="Policy transparency test").exists:
            ...
            click(d,'t',"OPEN SETTINGS",1)
            Fail9 = True
            click(d,'t',"Dummy accessibility service",1)
            if d(text="This action is disabled by your administrator. Contact someone@example.com for support.").exists:
                Fail9 = False
                click(d,'t',"LEARN MORE",1)
                if not d(text="Your admin can monitor and manage apps and data associated with your work profile, including settings, permissions, corporate access, network activity, and the device's location information.").exists:
            ...
            Fail0 = True
            click(d,'t',"Dummy input method",1)
            if d(text="This action is disabled by your administrator. Contact someone@example.com for support.").exists:
                Fail0 = False
                click(d,'t',"LEARN MORE",1)
                if not d(text="Your admin can monitor and manage apps and data associated with your work profile, including settings, permissions, corporate access, network activity, and the device's location information.").exists:
        ...
        if d(text="Profile-aware data usage settings (Wi-Fi)").exists:
            ...
            click(d,'t',"Wi‑Fi",1)
            d(scrollable=True).scroll.to(text="Wi‑Fi data usage")
            Fail = False
            if not d(text="Wi‑Fi data usage").enabled:
                Fail = True
        ...
        if d(text="Camera support cross profile video capture (without extra output path)").exists:
            ...
            click(d,'r',"com.android.camera2:id/shutter_button",10)
            click(d,'r',"com.android.camera2:id/shutter_button",3)
            click(d,'r',"com.android.camera2:id/done_button",2)
            d(text="PLAY").click()
        ...
        if d(text="Work profile widget").exists:
            ...
            click(d,'t',"Widgets",1)
            d.swipe(540,2000,540,1800,steps=10)
            d(text="CTS Verifier")[1].long_click()
            time.sleep(1)
            d.click(x,y)
            time.sleep(1)
            Fail = False
